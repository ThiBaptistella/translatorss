		...
		return this.each(function() {
					...
					if (a(this).data("text") != undefined) {
						...
						if (a(this).data("type") != undefined) {
							...
							if (i == "half") {
								a(this)
										.append('<span class="circle-text-half">'
												+ D + s + "</span>");
								...
								a(this).append('<span class="circle-text">' + D
										+ s + "</span>");
							...
							a(this).append('<span class="circle-text">' + D + s
									+ "</span>");
							a(this).find(".circle-text").css({
										"line-height" : F + "px",
										"font-size" : t + "px"
					...
					if (a(this).data("info") != undefined) {
						...
						if (a(this).data("type") != undefined) {
							...
							if (i == "half") {
								a(this)
										.append('<span class="circle-info-half">'
												+ E + "</span>");
								...
								a(this).append('<span class="circle-info">' + E
										+ "</span>");
