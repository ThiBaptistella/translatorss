...
<meta charset="utf-8">
  ...
  <base href="http://translatorss.com.au/" />
  ...
  <link href="/templates/yootheme/css/theme.css?v=1499968969" rel="stylesheet" type="text/css" id="theme-style-css" />
  <link href="/templates/yootheme/css/custom.css?v=1.4.3" rel="stylesheet" type="text/css" id="theme-custom-css" />
  <link href="//fonts.googleapis.com/css?family=Roboto%7CWork+Sans" rel="stylesheet" type="text/css" id="google-fonts-css" />
  <script src="/media/jui/js/jquery.min.js?5c75d2fac1157e9a0ef38837602b1014" type="text/javascript"></script>
  <script src="/media/jui/js/jquery-noconflict.js?5c75d2fac1157e9a0ef38837602b1014" type="text/javascript"></script>
  <script src="/media/jui/js/jquery-migrate.min.js?5c75d2fac1157e9a0ef38837602b1014" type="text/javascript"></script>
  <script src="/media/jui/js/bootstrap.min.js?5c75d2fac1157e9a0ef38837602b1014" type="text/javascript"></script>
  ...
  window.ga=window.ga||function(){(ga.q=ga.q||[]).push(arguments)}; ga.l=+new Date; ga('create','UA-57681269-21','auto'); ga('send','pageview');
  </script>
...
<div class="tm-header-mobile uk-hidden@m">
  <nav class="uk-navbar-container" uk-navbar>
    <div class="uk-navbar-left">
      <a class="uk-navbar-item uk-logo" href="http://translatorss.com.au">
        <img src="/images/logo-translatorss.svg" alt class="uk-responsive-height">        </a>
      </div>
      ...
      <div class="uk-child-width-1-1" uk-grid>
        <div><div class="uk-panel" id="module-0">
          <ul class="uk-nav uk-nav-default">
            ...
            <li><a href="/join-us">join us</a></li></ul>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="uk-navbar-container" uk-sticky media="768" cls-active="uk-active uk-navbar-sticky">
    <div class="uk-container ">
      <nav class="uk-navbar" uk-navbar="{&quot;align&quot;:&quot;center&quot;,&quot;dropbar&quot;:true,&quot;dropbar-anchor&quot;:&quot;!.uk-container&quot;,&quot;dropbar-mode&quot;:&quot;slide&quot;}">
        <div class="uk-navbar-left">
          <a href="http://translatorss.com.au" class="uk-logo uk-navbar-item">
            <img src="/images/logo-translatorss.svg" alt class="uk-responsive-height">
            <img src="/images/logo-translatorss-bco.svg" alt class="uk-responsive-height uk-logo-inverse"></a>
        </div>
          <div class="uk-navbar-right">
          ...
          <div class="uk-navbar-item" id="module-0">
            <div>
                <ul class="uk-grid-small uk-flex-middle uk-flex-nowrap" uk-grid>
                  ...
                  <li>
                    <a href="https://www.youtube.com" class="uk-icon-link" uk-icon="icon: youtube"></a>
                  </li>
                </ul>
            </div>
          </div>
...
<!-- form  -->
<form:form name="myForm" class="form-horizontal" action='serviceRequestProcesorHome' method="post" commandName="serviceRequestDTO" enctype="multipart/form-data">
<div class="uk-section-default uk-section">
              ...
              <div class="module-translator uk-panel">
                ...
                jQuery( document ).ready(function($) {
                  submitModal = function(){
                    $('#myModal').modal('show');
                    document.forms['form-inside'].submit();
                  }
                  submitModal_2 = function(){
                    $('#myModal').modal('show');
                    document.forms['form-mobile-inside'].submit();
                  }
                });
                </script>
                  ...
                  <div class="left-actions uk-padding-remove uk-width-1-3@m">
                    ...
                    <div class="step3">
                      ...
                      <div class="text">
                        ...
                        <h3 class="step-title3">Pay and get your document translated</h3>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="uk-grid">
                         ...
                         <div class="uk-grid">
                            <spring:bind path="serviceRequestCategory">
								...
								<form:select id="servicerequestcategory" class="uk-margin uk-select" path="serviceRequestCategory">
									<form:option value="" selected="">Please Select.....</form:option>
									<optgroup label="Personal Content">
										<form:option
												value="Birth, Death or Marriage Certificate">Birth, Death or Marriage Certificate</form:option>
                            ...
                            <div class="uk-grid">
                              <spring:bind path="description">
								...
								<form:textarea id="description" path="description" rows="5"  maxlength="200" class="uk-textarea" placeholder="Description: Eg: Applying, To Immigration, To be used on Court, Requested by School" />
                            ...
                            <div class="uk-grid">
                              <spring:bind path="timeFrame">
								...
								<form:select id="timeframe" class="uk-margin uk-select" path="timeFrame">
												<form:option value="" selected="">Please Select...</form:option>
                              ...
                              <div class="uk-grid">
                                ...
                                <div class="uk-width-1-2">
                                 <p uk-margin>
									<button class="uk-button uk-button-primary"  name="serviceRequestCreate" value="serviceRequestCreate">START</button>
		...
		<div class="uk-grid-margin uk-grid uk-grid-stack front-translatorss uk-hidden@m">
			  <div class="step1">
			    <div class="icons">
			      <i class="ticon-touch"></i>
			    </div>
			...
			<div class="uk-grid">
			  <div class="uk-width-1-2">
			    <p uk-margin>
				<button class="uk-button uk-button-primary"  name="serviceRequestCreate" value="serviceRequestCreate">START</button>
						Discovery now and free the cost of your translation.
				</p>
			  </div>
			</div>
			<div class="step2">
...
<%-- 
<div class="uk-flex uk-height-medium uk-background-muted uk-margin uk-text-left">
	<div class="uk-margin-auto uk-margin-auto-vertical uk-width-1-2@s uk-card uk-card-default uk-card-body">

<form:form name="myForm" class="form-horizontal" action='serviceRequestProcesorHome' method="post" commandName="serviceRequestDTO" enctype="multipart/form-data">

				<fieldset class="uk-fieldset">
				<legend class="uk-legend">Translatorss</legend>
				<label style="color: green">Language From</label>
				<spring:bind path="languagefrom">
					<form:select id="languagefrom" class="uk-margin uk-select"  path="languagefrom" items="${languageList}" itemValue="description" itemLabel="description" multiple="false" />
					<p id="languagefromerror" style="color: red"></p>
...
<!-- Get quote -->
<div class="modal" id="quoteModal" role="dialog"
	 aria-labelledby="myModalLabel" aria-hidden="false">
	<div class="modal-backdrop  in" style="height: 102px;"></div>
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
...
<!-- testimonial -->
<div class="uk-section-primary uk-section" uk-scrollspy="{&quot;target&quot;:&quot;[uk-scrollspy-class]&quot;,&quot;cls&quot;:&quot;uk-animation-scale-up&quot;,&quot;delay&quot;:300}">
  <div class="uk-container">
    <div class="uk-grid-margin" uk-grid>
      <div class="uk-width-1-1@m uk-text-center">
        <p class="uk-text-center" uk-scrollspy-class>
          Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque.
          <footer>
            Camilla Stevens // Brazilian student.
          </footer>
        </p>
      </div>
    </div>
    ...
    <div class="uk-width-xlarge@m">
      <div class="uk-margin uk-card uk-card-default uk-card-large uk-card-body" uk-scrollspy-class>
        ...
        <h3 class="uk-margin uk-h1">
          Certified Native Translation Service    </h3>
          <div class="uk-margin"><p class="uk-margin-large-bottom">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque.</p></div>
        </div>
     </div>
      <div class="uk-width-expand@m">
        <div class="uk-margin-medium uk-text-left@s uk-text-center uk-grid-match uk-child-width-1-1 uk-child-width-1-2@s" uk-scrollspy-class="uk-animation-slide-right" uk-grid>
          <div><div uk-scrollspy-class class="uk-panel">
            <img src="http://www.translatorss.com.au/images/yootheme/home-services-04.svg" alt>
            <h3 class="uk-margin uk-h4">
              Vision    </h3>
              <div class="uk-margin">Lorem ipsum dolor sit amet, eleifend gravida non maecenas veritatis vestum eos, nisl volutpat.</div>
            </div>
          </div>
          <div><div uk-scrollspy-class class="uk-panel">
...
<div style="background-image: url('/images/join-us-home.jpg'); background-color: #fff;" class="uk-background-norepeat uk-background-cover uk-background-image@m uk-section uk-section-xsmall uk-flex uk-flex-middle" uk-height-viewport="offset-top: true">
    ...
    <div class="uk-grid-large uk-grid-margin-large" uk-grid>
      <div class="uk-width-expand@m">
        <div class="uk-margin" uk-scrollspy-class>
          <video controls poster="/templates/yootheme/vendor/yootheme/theme/assets/images/element-video-placeholder.png"></video>
        </div>
      </div>
          ...
          <h1 class="uk-margin-medium uk-margin-remove-top uk-width-xlarge uk-margin-auto uk-text-center" uk-scrollspy-class>
            ...
            <div class="uk-margin uk-width-xlarge uk-margin-auto uk-text-center" uk-scrollspy-class>
              ...
              <div class="uk-margin uk-text-center" uk-scrollspy-class>
                <a class="uk-button uk-button-default" href="http://www.translatorss.com.au/join-us" title="JOIN US">
                  JOIN US
                </a>
              </div>
            </div>
    ...
    <div class="uk-container">
      <div class="uk-grid-large uk-grid-margin-large" uk-grid>
        <div class="uk-width-expand@m uk-width-1-2@s">
          <div class="uk-margin" uk-scrollspy-class>
            <a href="/index.php"><img src="/images/logo-translatorss.svg" alt width="70%"></a>
          </div>
          <div class="uk-margin uk-width-xlarge" uk-scrollspy-class>
            ...
            <div class="uk-margin" uk-scrollspy-class>
              <div class="uk-child-width-auto uk-flex-inline uk-grid-medium" uk-grid>
                <div>
                  <a uk-icon="icon: instagram;ratio: 0.8" href="https://www.instagram.com/" class="uk-link-muted"></a>
                </div>
                <div>
                  <a uk-icon="icon: twitter;ratio: 0.8" href="https://twitter.com/" class="uk-link-muted"></a>
                </div>
                <div>
                  <a uk-icon="icon: facebook;ratio: 0.8" href="https://www.facebook.com/" class="uk-link-muted"></a>
                </div>
              </div>
            </div>
          </div>
          <div class="uk-width-expand@m uk-width-1-2@s">
            <h3 class="uk-h5" uk-scrollspy-class>
              ...
              <div class="uk-margin" uk-scrollspy-class>
                ...
                +61 2 9250 7111<br>
                <span id="cloak1bdb9de69b23860fe1c8d1c4015a2a64">This email address is being protected from spambots. You need JavaScript enabled to view it.</span>
                <script type='text/javascript'>
                document.getElementById('cloak1bdb9de69b23860fe1c8d1c4015a2a64').innerHTML = '';
                var prefix = '&#109;a' + 'i&#108;' + '&#116;o';
                var path = 'hr' + 'ef' + '=';
                var addy1bdb9de69b23860fe1c8d1c4015a2a64 = 'sydn&#101;y' + '&#64;';
                addy1bdb9de69b23860fe1c8d1c4015a2a64 = addy1bdb9de69b23860fe1c8d1c4015a2a64 + 'tr&#97;nsl&#97;t&#111;rss' + '&#46;' + 'c&#111;m' + '&#46;' + '&#97;&#117;';
                var addy_text1bdb9de69b23860fe1c8d1c4015a2a64 = 'sydn&#101;y' + '&#64;' + 'tr&#97;nsl&#97;t&#111;rss' + '&#46;' + 'c&#111;m' + '&#46;' + '&#97;&#117;';document.getElementById('cloak1bdb9de69b23860fe1c8d1c4015a2a64').innerHTML += '<a ' + path + '\'' + prefix + ':' + addy1bdb9de69b23860fe1c8d1c4015a2a64 + '\'>'+addy_text1bdb9de69b23860fe1c8d1c4015a2a64+'<\/a>';
                </script>
                </div>
              </div>
              <div class="uk-width-expand@m uk-width-1-2@s">
                <h3 class="uk-h5" uk-scrollspy-class>
                  ...
                  <div class="uk-margin" uk-scrollspy-class>
                    ...
                    Sydney NSW 2000, Austrália<br>
                    +61 2 9250 7111<br>
                    <span id="cloak0710aa8d8d13f69815a7378b7af27387">This email address is being protected from spambots. You need JavaScript enabled to view it.</span><script type='text/javascript'>
                    document.getElementById('cloak0710aa8d8d13f69815a7378b7af27387').innerHTML = '';
                    var prefix = '&#109;a' + 'i&#108;' + '&#116;o';
                    var path = 'hr' + 'ef' + '=';
                    var addy0710aa8d8d13f69815a7378b7af27387 = 'br&#105;sb&#97;n&#101;' + '&#64;';
                    addy0710aa8d8d13f69815a7378b7af27387 = addy0710aa8d8d13f69815a7378b7af27387 + 'tr&#97;nsl&#97;t&#111;rss' + '&#46;' + 'c&#111;m' + '&#46;' + '&#97;&#117;';
                    var addy_text0710aa8d8d13f69815a7378b7af27387 = 'br&#105;sb&#97;n&#101;' + '&#64;' + 'tr&#97;nsl&#97;t&#111;rss' + '&#46;' + 'c&#111;m' + '&#46;' + '&#97;&#117;';document.getElementById('cloak0710aa8d8d13f69815a7378b7af27387').innerHTML += '<a ' + path + '\'' + prefix + ':' + addy0710aa8d8d13f69815a7378b7af27387 + '\'>'+addy_text0710aa8d8d13f69815a7378b7af27387+'<\/a>';
                    </script></div>
                  </div>
                  <div class="uk-width-expand@m uk-width-1-2@s">
                    <h3 class="uk-h5" uk-scrollspy-class>
                      ...
                      <div class="uk-margin" uk-scrollspy-class>
                        ...
                        Sydney NSW 2000, Austrália<br>
                        +61 2 9250 7111<br>
                        <span id="cloak375fc33778532164a3ef6011f3b43a69">This email address is being protected from spambots. You need JavaScript enabled to view it.</span><script type='text/javascript'>
                        document.getElementById('cloak375fc33778532164a3ef6011f3b43a69').innerHTML = '';
                        var prefix = '&#109;a' + 'i&#108;' + '&#116;o';
                        var path = 'hr' + 'ef' + '=';
                        var addy375fc33778532164a3ef6011f3b43a69 = 'm&#101;lb&#111;&#117;rn&#101;' + '&#64;';
                        addy375fc33778532164a3ef6011f3b43a69 = addy375fc33778532164a3ef6011f3b43a69 + 'tr&#97;nsl&#97;t&#111;rss' + '&#46;' + 'c&#111;m' + '&#46;' + '&#97;&#117;';
                        var addy_text375fc33778532164a3ef6011f3b43a69 = 'm&#101;lb&#111;&#117;rn&#101;' + '&#64;' + 'tr&#97;nsl&#97;t&#111;rss' + '&#46;' + 'c&#111;m' + '&#46;' + '&#97;&#117;';document.getElementById('cloak375fc33778532164a3ef6011f3b43a69').innerHTML += '<a ' + path + '\'' + prefix + ':' + addy375fc33778532164a3ef6011f3b43a69 + '\'>'+addy_text375fc33778532164a3ef6011f3b43a69+'<\/a>';
                        </script></div>
                      </div>
                    </div>
                  </div>
