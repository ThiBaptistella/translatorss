						...
						<div class="uk-navbar-item" id="module-0">
							<div>
								<ul class="uk-grid-small uk-flex-middle uk-flex-nowrap" uk-grid>
									<li><a href="https://www.facebook.com/Translatorss/" 
										   target="blank" class="uk-icon-link" uk-icon="icon: facebook"></a></li>
									<li><a href="https://www.instagram.com/translatorss.com.au/?hl=en"
										 target="blank" class="uk-icon-link" uk-icon="icon: instagram"></a></li>
			...
			<div class="uk-grid-large uk-grid-margin-large" uk-grid>
				<div class="uk-width-expand@m uk-width-1-2@s">
					...
					<div class="uk-margin uk-width-xlarge" uk-scrollspy-class>
						ABN: 123456789 , <br /> Translators copy&right.
						</div>
					<div class="uk-margin" uk-scrollspy-class>
						<div class="uk-child-width-auto uk-flex-inline uk-grid-medium"
							...
							<div>
								<a uk-icon="icon: instagram;ratio: 0.8"
									href="https://www.instagram.com/translatorss.com.au/?hl=en" target="blank" class="uk-link-muted"></a>
							</div>
							<div>
								<a uk-icon="icon: facebook;ratio: 0.8"
									href="https://www.facebook.com/Translatorss/" target="blank" class="uk-link-muted"></a>
							</div>
						</div>
					</div>
				</div>
