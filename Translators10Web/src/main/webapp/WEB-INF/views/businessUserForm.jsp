								...
								<div class="tab-pane active" id="tab_0">
									<div class="portlet box blue">
										...
										<div class="portlet-body form">
											<div id="loginform">
											<form:form action='${pageContext.request.contextPath}/j_spring_security_check' class="form-horizontal" method="post" commandName="loginSRForm" id="loginForm">
												<div class="form-body">
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<div class="input-group">
																...
																<form:input path="email" class='form-control input-circle-right' size='4' type='text' id="email" name="email" value="${param.customer}" placeholder="Enter your Email" />
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<div class="input-group">
																<form:input path="password" autocomplete='off' class='form-control input-circle-left' size='20' type='text' id="password" name="password" placeholder="Password" />
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<div class="input-group">
																<button type="submit" class="btn btn-circle blue">Sign In</button>
															</div>
														</div>
													</div>
												</div>
											...
											<div id="registerform">
												<form:form name="myFormUserregister" action='registerBusinessUser' class="form-horizontal" onsubmit="return validateFormRegis()" method="post" commandName="businessUserForm" >
													<div class="form-body">
														<div class="form-group">
													...
													<div class="form-group">
														<div class="col-sm-10 btnRegister">
															<button name="translatorsave" value="TranslatorSave" class="btn-lg btn-primary pull-right">Register</button>
														</div>
														<div class="col-sm-2"></div>
													</div>
												</form:form>
