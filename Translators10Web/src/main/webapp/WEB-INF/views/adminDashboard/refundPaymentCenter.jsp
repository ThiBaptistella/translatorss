            ...
            <div class="row">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Refund Customer Center</h3>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Refund Payment File Generation Center</h3>
                        </div>
                        <div class="panel-body">                        
                            <c:if test="${not empty paymentList}">
					            <spring:url value="/downloadPaymentTranslatorsCSV/Refunded" var="downloadCSV" />
									<button class="btn btn-primary" onclick="location.href='${downloadCSV}'">Generate CSV Refund File</button>
				                </c:if>
