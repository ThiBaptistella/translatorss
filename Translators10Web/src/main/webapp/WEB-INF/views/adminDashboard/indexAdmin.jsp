...
<html lang="en" ng-app="translatorss" >
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
               ...
               <a href="indexUser.jsp" class="img-responsive"><img src="resources/images/logo.png"  /></a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu alert-dropdown">
                        ...
                        <li>
                            <a href="#">You have new messages <span class="label label-info">Alert Badge</span></a>
                        </li>
                        <li>
                            <a href="#">You´ve received a quotation! <span class="label label-success">Alert Badge</span></a>
                        </li>
                        <li>
                            <a href="#">Review your translations <span class="label label-danger">Alert Badge</span></a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">View All</a>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> ${loggedInAdmin.user.name}<%-- <%= session.getAttribute( "theName" ) %> --%><b class="caret"></b></a>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-footer">
                                    <span class="pull-left"><a href="<c:url value='jobInProgress'/>"><i class="fa fa-fw fa-table"></i>View Details</a></span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-green">
                            ...
                            <div class="panel-footer">
                                    <span class="pull-left"><a href="<c:url value='pendingActions'/>" ><i class="fa fa-fw fa-table"></i>View Details</a></span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-red">
                            ...
                            <div class="panel-footer">
                                    <span class="pull-left"><a href="<c:url value='history'/>" ><i class="fa fa-fw fa-table"></i>History</a></span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                            </div>
                        </div>
	...
	<script type="text/javascript" src="../../angular-1.4.4/angular.min.js"></script>
	<script type="text/javascript" src="../../angular-1.4.4/angular-route.min.js"></script>
