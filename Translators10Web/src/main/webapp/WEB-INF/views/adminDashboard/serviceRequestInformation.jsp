...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-edit"></i> Messages
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                 ...
                 <c:if test="${serviceRequestStatus == 'OpenService'}">
	                 <div class="col-lg-6">
					          <div class="panel panel-primary">
					            <div class="panel-heading">
					              <h3 class="panel-title">Case Resolution Options</h3>
					            </div>
					            <div class="panel-body">
			                                    ...
			                                    <tbody>
				                                  <%--  <c:forEach items="${serviceRequestList}" var="serviceRequest">
				                                        <tr class="active">
															...
															<td>${serviceRequest.translator.name}</td>	
				                                        </tr>
				                                    </c:forEach>
				                                     --%>
			                                    </tbody>
			                                    ...
			                                    <tbody>
				                                   <c:forEach items="${fileList}" var="file">
				                                        <tr class="active">
				                                        	<td>${file.id}</td>
				                                        	<td>
				                                        		<a href="<c:url value='/downloadFile2/${file.id}/${file.type}'/>" >${file.name}</a>
				                                        	</td> 
				                                            <td>${file.sender}</td>
				                                            <td>${file.date}</td>  
				                                        </tr>
    ...
    <script type="text/javascript" charset="utf8" src="//cdn.datatables.net/1.10.10/js/jquery.dataTables.min.js"></script>
 	...
 	<script type="text/javascript">
 	 var es = new EventSource("/translatorss/checkMessageInsert/${conversationid}/" + guid());
