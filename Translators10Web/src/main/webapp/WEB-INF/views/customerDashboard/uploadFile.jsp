                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <spring:bind path="languagefrom">
                                                            <div class="form-group">
                                                                <label class="col-sm-2 control-label" for="languageList"><b>Original Language</b></label>
                                                                <div class="col-sm-3">
                                                                    <div class="row">
                                                                        <form:select name="languagefrom" id="languagefrom" class="form-control col-sm-2" path="languagefrom" onclick="onclickCleanField('languagefromerror')" items="${languageList}" itemValue="description" itemLabel="description" multiple="false" size="15" />
                                                        ...
                                                        <spring:bind path="serviceRequestCategory">
                                                            <div class="form-group">
                                                                <label class="col-sm-2 control-label" for="expiry-month"><b>Document Category</b></label>
                                                                <div class="col-sm-3">
                                                                    <div class="row">
                                                                        <form:select id="servicerequestcategory" class="form-control col-sm-2" path="serviceRequestCategory" onclick="onclickCleanField('servicerequestcategoryerror')">
                                                        ...
                                                        <spring:bind path="description">
                                                            <div class="form-group">
                                                                <label class="col-sm-2 control-label"><b>Description (e.g. to be presented to immigration governemnt department, to be presented to a university, to be presented in court...)</b></label>
                                                                <div class="col-sm-3">
                                                                    <div class="row">
                                                                        <form:textarea path="description" rows="5" cols="30" maxlength="200" class="form-control" onclick="onclickCleanField('descriptionerror')" name="description" id="description" placeholder="Description"/>
                                                        ...
                                                        <spring:bind path="hardcopy">
                                                            <div class="form-group">
                                                                <label class="col-sm-2 control-label"><b>hardcopy (within Australia only) </b></label>
                                                                <div class="col-sm-4">
                                                                    <div class="row">
                                                                        <div class="checkbox">
                                                        ...
                                                        <spring:bind path="timeFrame">
                                                            <div class="form-group">
                                                                <label class="col-sm-2 control-label" for="expiry-month"><b>Digital Copy Urgency</b></label>
                                                                <div class="col-sm-3">
                                                                    <div class="row">
                                                                        <form:select id="timeframeid" class="form-control col-sm-2" path="timeFrame" onclick="onclickCleanField('timeframeerror')">
                                                                            <form:option value="" selected="">Please Select...</form:option>
                                                        ...
                                                        <spring:bind path="files">
                                                            <div class="form-group">
                                                                <label class="col-sm-2 control-label" for="expiry-month"><b>Upload files</b></label>
                                                                <div class="col-sm-3">
                                                                    <div class="row">
                                                                       <!--<table id="fileTable">
                                                                            <tr>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-offset-2 col-sm-10">
                                                                <button name="serviceRequestCreate" id="mySubmitButton" value="serviceRequestCreate" class="btn btn-primary btn-bMember">Select a translator</button>
                                                            </div>
                                                        </div>
                                                    </fieldset>
                                                </form:form>
