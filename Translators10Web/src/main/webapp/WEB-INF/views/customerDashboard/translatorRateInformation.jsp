        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Translator's rate List</span>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-cogs"></i>Translator's rate List</div>
                        </div>
                                ...
                                <tbody>
                                    <c:forEach items="${rateList}" var="rate">
                                        <tr>
                                            ...
                                            <td>
                                                <c:if test="${rate.serviceAsDescribed =='5'}">
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i>
                                                ...
                                                <c:if test="${rate.serviceAsDescribed =='4'}">
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i>
                                                ...
                                                <c:if test="${rate.serviceAsDescribed =='3'}">
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star-o"></i>
                                                ...
                                                <c:if test="${rate.serviceAsDescribed =='2'}">
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star-o"></i>
                                                    <i class="fa fa-star-o"></i>
                                                ...
                                                <c:if test="${rate.serviceAsDescribed =='1'}">
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star-o"></i>
                                                    <i class="fa fa-star-o"></i>
                                                    <i class="fa fa-star-o"></i>
                                                ...
                                                <c:if test="${rate.serviceAsDescribed =='0'}">
                                                    <i class="fa fa-star-o"></i>
                                                    <i class="fa fa-star-o"></i>
                                                    <i class="fa fa-star-o"></i>
                                                    <i class="fa fa-star-o"></i>
