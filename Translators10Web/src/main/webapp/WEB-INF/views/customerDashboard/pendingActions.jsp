                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Select your Translator </div>
                                </div>
		      ...
		      <script src="resources/js/datatable.js"></script>
				...
				<script type="text/javascript">
				    function specialCountDownOperations(ref, event, stop) {
				         if (event.elapsed  && !stop) {
				            var serviceRequestId = $(ref).data("id");
				            window.location.replace("/expireServiceRequest/" + serviceRequestId);
				            stop = true;
				        }
				        return stop;
				       }
