                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Translation History</div>
                                </div>
                                    ...
                                    <table class="table table-bordered table-striped table-condensed flip-content" id="tableData">
                                        <thead class="flip-content">
                                           <%--<tr>
			                                      ...
			                                      <th class="text-center"onclick="sortTable(3)">From</th>
			                                      <th class="text-center"onclick="sortTable(4)">To</th>
			                                      <th class="text-center"onclick="sortTable(5)">Translator</th>
