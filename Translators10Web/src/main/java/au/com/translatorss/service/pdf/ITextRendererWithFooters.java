package au.com.translatorss.service.pdf;
...
public class ITextRendererWithFooters extends ITextRenderer{
    ...
    public ITextRendererWithFooters() {
        this(DEFAULT_DOTS_PER_POINT, DEFAULT_DOTS_PER_PIXEL);
    }

    public ITextRendererWithFooters(float dotsPerPoint, int dotsPerPixel) {
    ...
    private LayoutContext newLayoutContext() {
        ...
        result.setFontContext(new ITextFontContext());
        //custom start
        result.setExtraSpaceBottom(footerHeight);
        //custom end
        _sharedContext.getTextRenderer().setup(result.getFontContext());
    ...
    public void writeNextDocument(int initialPageNo) throws DocumentException {
        java.util.List pages = _root.getLayer().getPages();
    ...
    private void writePDF(java.util.List pages, RenderingContext c, com.lowagie.text.Rectangle firstPageSize, com.lowagie.text.Document doc,
    ...
    public java.util.List findPagePositionsByID(Pattern pattern) {
